...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 19, 2020 at 07:30 AM
...
INSERT INTO `address` (`address_id`, `user_id`, `receiver_name`, `receiver_phone`, `city`, `society`, `house_no`, `landmark`, `state`, `pincode`, `lat`, `lng`, `select_status`, `added_at`, `updated_at`) VALUES
(1, 2, 'komal', '02225878', 'panvel', 'test', '103', 'bikaner sweet mart', 'maharashtra', '410206', '', '', 1, '0000-00-00 00:00:00', '2020-09-17 22:03:55');
...
(1, 'GoGrocer Admin', 'admin@demo.com', '$2y$10$uxaJ5ExbwToFEXHe.YuFQuaDWm6VjvBZVk4ZFcdG1Fk/SWv0aZIfK', 'images/admin/profile/07-04-20/070420120712pm-604a0cadf94914c7ee6c6e552e9b4487-curved-check-mark-circle-icon-by-vexels.png');
...
(5, 'banner1', 'images/banner/060520100312am-download-(7).jpg'),
...
(1, 'test', 'test', 'public/images/category/16-09-2020/Screenshot-(3).png', 0, 0, 'test', 1),
(2, 'test2', 'test2', 'images/category/15-09-2020/veg.png', 0, 0, 'test2', 1),
(3, 'tst', 'tst', 'images/category/15-09-2020/veg.png', 2, 1, 'tst', 1),
(4, 'sdfg', 'sdfg', 'public/images/category/15-09-2020/icons8-thumbs-up-48-(2).png', 1, 1, 'sdfg', 1),
(5, 'test new', 'test-new', 'public/images/category/16-09-2020/Screenshot-(3).png', 1, 1, 'test new', 1);
...
(1, 'No Cooking April Offer', 'APRI40', 'No cooking April use this code & get upto 50% off', '2020-05-01 00:00:00', '2020-09-10 00:00:00', 150, 40, 'Percentage', 2),
(2, 'testing', 'APE245', 'sdfjv mdsfbvdn bmfsnbmx m vskn ,dz v,sldmv zk;dnf,bn w', '2020-05-01 00:00:00', '2020-09-10 00:00:00', 150, 100, 'price', 2),
(3, 'TASTY', 'TASTYTO', '24 rs off on 800', '2020-06-02 14:52:00', '2020-06-09 14:52:00', 800, 24, 'price', 1);
...
INSERT INTO `deal_product` (`deal_id`, `varient_id`, `deal_price`, `valid_from`, `valid_to`, `status`) VALUES
(1, 1, 250, '2020-09-16 11:31:00', '2020-09-17 11:31:00', 1);
...
(1, '352076647507', 'AAAAUflnTFM:APA91bGcB3DdSV_K5tKBDOJherPDN0TlQsYNeUzS92HSz0Ou1c_d0ty2Mvp_XAcxYMhqdh0XQG57cMC_8P2N_lFZmZQT55EZ2sfAx_d84ztVMYHGWaUfYwD-vQN', 'AAAAUJ_m7EYr0iyqcolGcB3DdSV_K5tKBDOJherPDN0TlQsYNeUzS92HSz0Ou1c_d0ty2Mvp_XAcxYMhqdh0XQG57cMC_8P2N_lFZmZQT55EZ2sfAx_d84ztVMYHGWaUfYwD-vQN', 'AAAAUJ_m7EYr0iyqcolGcB3DdSV_K5tKBDOJherPDN0TlQsYNeUzS92HSz0Ou1c_d0ty2Mvp_XAcxYMhqdh0XQG57cMC_8P2N_lFZmZQT55EZ2sfAx_d84ztVMYHGWaUfYwD-vQN');
...
(1, 'AIzaSyDq6a7_3efgfdfcnxJMkehXRdvfk1lB1E');
...
INSERT INTO `product` (`product_id`, `cat_id`, `product_name`, `product_image`, `hide`) VALUES
(1, 5, 'rice', 'public/images/product/16-09-2020/Screenshot-(3).png', 0);
...
INSERT INTO `product_varient` (`varient_id`, `product_id`, `quantity`, `unit`, `base_mrp`, `base_price`, `description`, `varient_image`) VALUES
(1, 1, 1, '10 KG', 280, 250, 'test product', 'public/images/product/16-09-2020/Screenshot-(3).png');
...
INSERT INTO `society` (`society_id`, `society_name`, `city_id`) VALUES
(4, 'Laxmi Nagar', 1),
(6, 'sector-58', 3),
(7, 'Sector-55', 3),
(10, 'New Kolkata', 13);
...
INSERT INTO `store_products` (`p_id`, `varient_id`, `stock`, `store_id`, `mrp`, `price`) VALUES
(1, 1, 10, 1, 25, 30);
...
CREATE TABLE `subscription` (
  ...
  `repeat_on` varchar(200) NOT NULL,
  `address` varchar(500) NOT NULL,
  `subscription_date` date NOT NULL,
  `delivery_start_date` date NOT NULL DEFAULT current_timestamp(),
  `delivery_end_date` date NOT NULL DEFAULT current_timestamp(),
...
INSERT INTO `subscription` (`sub_id`, `user_id`, `store_id`, `product_id`, `product_quantity`, `repeat_on`, `address`, `subscription_date`, `delivery_start_date`, `delivery_end_date`, `time_slot`, `sub_status`) VALUES
(1, 2, 1, 1, 2, 'Everyday', 'addr', '2020-09-17', '2020-09-01', '2020-09-18', '2PM', 0),
(2, 2, 20, 14, 10, '', 'addr', '2020-09-17', '2020-02-01', '2020-03-01', '2PM', 0),
(3, 2, 20, 14, 10, '', 'addr', '2020-09-17', '2020-02-01', '2020-03-01', '2PM', 0),
(4, 2, 1, 1, 10, 'one time delivery', '103 test panvel , landmark: bikaner sweet mart , state-maharashtra , pincode : 410206', '2020-09-17', '2020-02-01', '2020-03-01', '2PM', 0),
(5, 2, 1, 14, 10, 'Everyday', '103 test panvel , landmark: bikaner sweet mart , state-maharashtra , pincode : 410206', '2020-09-18', '2020-02-01', '2020-03-01', '2PM', 0);
...
CREATE TABLE `subscription_payment` (
  `sub_payment_id` int(11) NOT NULL,
  `sub_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `subscription_days` int(11) NOT NULL,
  `price_of_singleday` float NOT NULL,
  `one_day_delivery_charge` float NOT NULL,
  `one_day_price_with_delivery` float NOT NULL,
  `total_price` float NOT NULL,
  `payment_method` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `paid_by_wallet` float NOT NULL DEFAULT 0,
  `rem_price` float NOT NULL DEFAULT 0,
  `subscription_payment_date` date NOT NULL DEFAULT current_timestamp(),
...
(1, 'images/app_logo/favicon/11-05-2020/gogrocer-icon.png', 'GoGrocerey', 'images/app_logo/favicon/11-05-2020/gogrocer-icon.png');
...
(1, 'AC301fdc7bb65f1d359ba9217e26a2b076', 'd6f8aa81a27981136a38c3562f465ad1', '+19169995023', 0);
...
INSERT INTO `users` (`user_id`, `user_name`, `user_phone`, `user_email`, `device_id`, `user_image`, `user_password`, `otp_value`, `status`, `wallet`, `rewards`, `is_verified`, `block`, `reg_date`) VALUES
(3, 'admin', '1234567891', 'admin@demo.com', '123', 'N/A', 'admin123', NULL, 1, 0, 0, 1, 2, '2020-09-17 13:55:02');
...
ALTER TABLE `subscription_payment`
  ADD PRIMARY KEY (`sub_payment_id`);
...
--
ALTER TABLE `banner`
  MODIFY `banner_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `city`
  MODIFY `city_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `product_varient`
  MODIFY `varient_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `society`
  MODIFY `society_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
-- AUTO_INCREMENT for table `store_doc`
--
ALTER TABLE `store_doc`
...
--
ALTER TABLE `store_society`
  MODIFY `store_society_id` int(100) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `subscription_payment`
  MODIFY `sub_payment_id` int(11) NOT NULL AUTO_INCREMENT;
